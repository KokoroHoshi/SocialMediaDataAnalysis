...
# --- decision tree again (acc = 0.7682927) ---
...
# --- linear regresstion (acc = 0.8170732)---
...
# --- multinomial logistic regression (acc = 0.8170732) ---
